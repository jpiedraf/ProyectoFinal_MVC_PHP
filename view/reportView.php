...
<body class="vh-100">
    ...
    <main class="container-fluid h-100 d-flex align-items-center justify-content-start flex-column w-100">
        <div class="container text-center mt-4 mb-3">
            <h1 class="promo-table__title d-inline me-3">Reporte de ventas</h1>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="btn_search-sales" type="button" class="btn btn-primary">Buscar</button>
                    </div>
                </div>
            </div>
        </div>
